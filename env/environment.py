...
class MultiAgentEnv(gym.Env):
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None,
        ...
        self.agent_types = ['agent' for i in range(self.num_agents)]
        ...
        for agent in self.agents:
            ...
            if self.discrete_action_space:
                ...
                u_action_space = spaces.Box(
                    low=-agent.u_range, high=+agent.u_range, shape=(world.dim_c,), dtype=np.float32)  # [-1,1]
            if agent.movable:
    ...
    def step(self, action_n):
        ...
        if self.post_step_callback is not None:
            self.post_step_callback(action_n,self.world)
            ...
            if self.discrete_action_input:
                ...
                if self.discrete_action_space:
                    ...
                    if self.force_discrete_action:
                        ...
                        action[0][:] = 0.0
                        action[0][p] = 1.0
                    agent.action.u = action[0][0:self.world.dim_p].copy()
                    d = self.world.dim_p
        ...
        if self.render_geoms is None:
            ...
            for entity in self.world.entities:
                ...
                if  'agent' in entity.name:
                    ...
                    geom = rendering.make_capsule(entity.size, entity.size)
                ...
                if 'agent' in entity.name:
                    ...
                    if entity.channel is not None:
                        ...
                        for ci in range(dim_c):
                            ...
                            comm = rendering.make_circle(10 / dim_c)
                            comm.set_color(1, 1, 1)
                            comm.add_attr(xform)
                            offset = rendering.Transform()
                            comm_size = (entity.size / dim_c)
